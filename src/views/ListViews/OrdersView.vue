...
export default {
    ...
    data() {
      return {        
        ...
        headers: [
            {text: "orderNumber", value: "orderNumber", width: '30px',  class:"blue lighten-5"},
            {text: "orderDate", value: "orderDate", width: '30px', align: 'right',  class:"blue lighten-5"},
            {text: "requiredDate", value: "requiredDate", width: '30px', align: 'right',  class:"blue lighten-5"},
            {text: "shippedDate", value: "shippedDate", width: '30px', align: 'right',  class:"blue lighten-5"},
            {text: "status", value: "status", width: '20px',  class:"blue lighten-5"},
            {text: "comments", value: "comments", width: '400px',  class:"blue lighten-5"},            
            {text: "customerName", value: "customerName", width: '200px',  class:"blue lighten-5"},
