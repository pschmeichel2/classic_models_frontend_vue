    ...
    <div class="home">
        ...
        <v-card max-width="1000px">
            ...
            <v-card-text>
                <v-row>
                    <v-col cols="4">
                        <v-text-field label="City" id="city" v-model="office.city" dense class="font-weight-bold"
                ...
                <v-row>
                    <v-col cols="4">
                        <v-text-field label="Country" v-model="office.country" dense class="font-weight-bold"
                            readonly></v-text-field>
                    </v-col>
                    <v-col cols="4">
