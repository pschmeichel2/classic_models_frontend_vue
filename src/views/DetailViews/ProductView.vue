<template>
    <div class="home">
            ...
            <v-card-text>
                ...
                <v-row >
                    <v-col cols="4">
                        ...
                        prepend-icon="mdi-open-in-app"  @click:prepend="handleClickProductLine" :readonly="true"></v-text-field>
                    </v-col>
                    <v-col cols="4">
                ...
                <v-row >
                    ...
                    <v-col cols="4">
                        <v-text-field label="Buy Price" v-model="product.buyPrice" dense 
                        :readonly="true"></v-text-field>
                    </v-col>
                    <v-col cols="4">
                        <v-text-field label="MSRP" v-model="product.msrp" dense 
                        :readonly="true"></v-text-field>
                    </v-col>
                </v-row>
                <v-row >
                    <v-col cols="12">
                        <v-textarea label="Product Description" rows="1" auto-grow v-model="product.productDescription" dense
        ...
        <v-card flat  max-width="1000px" >
            ...
            <v-data-table :items="orderDetails" :headers="orderDetailHeaders" item-key="getUniqueKey(item)" dense class="elevation-3"
