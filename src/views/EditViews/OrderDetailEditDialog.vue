<template>
    <v-dialog persistent v-model="show" max-width="1000px" height="400px" ref="Dialog" @keydown.esc="show = false">
        <v-card>
            ...
            <v-card-text>
                <v-row>
                    <v-col cols="2">
                        <v-text-field label="Product Code" dense :readonly="true" v-model="orderDetail.productCode"
                            ref="productCodeRef" append-icon="mdi-car-search" @click:append="handleClickFindProduct"
                ...
                <v-row>
                    ...
                    <v-col cols="3">
                        <v-text-field label="Price each" dense reverse v-model="orderDetail.priceEach" required
                            maxlength="10" :rules="[rules.isCurrency]" type="number" />
                    </v-col>
                </v-row>
            </v-card-text>
            <p></p>
