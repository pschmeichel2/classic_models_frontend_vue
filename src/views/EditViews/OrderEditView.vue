    ...
    <div class="home">
        <v-card max-width="1000px">
            ...
            <v-card-text>
                ...
                <v-row>
                    <v-col cols="2">
                        <v-text-field label="Required Date" type="date" v-model="requiredDate" dense
                            class="font-weight-bold"></v-text-field>
                    </v-col>
                    <v-col cols="2">
                        <v-select v-model="order.status" :items="statusValues" label="Status" dense
                            class="font-weight-bold"></v-select>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col cols="2">
        ...
        <v-card flat max-width="1000px">
            ...
            <v-data-table :items="orderDetails" :headers="orderDetailHeaders" item-key="productCode" dense
                class="elevation-3" :items-per-page="15" :single-select="true" show-select v-model="selected"
