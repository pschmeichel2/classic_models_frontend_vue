    ...
    <div class="home">
        ...
        <v-card max-width="1000px"  >
            ...
            <v-card-text>
                ...
                <v-row >
                    <v-col cols="4">
                        <v-combobox label="Country" v-model="country" 
                            :items="countryValues"
                            dense class="font-weight-bold"  @keyup.enter="handleClickSave" 
                            required maxlength="50"  :rules="[rules.required, rules.countryCounter]" counter
                            clearable>
                        </v-combobox>
                    </v-col>
                    <v-col cols="4">
                        <v-text-field label="State" v-model="state" dense  
                            maxlength="50"  :rules="[rules.stateCounter]" counter
                            hint="e.g. NY,CA,MA (not required)"></v-text-field>
                    </v-col>
                    <v-col cols="2">
                    ...
                    <v-col cols="2">
                        ...
                        required maxlength="10"  :rules="[rules.required, rules.territoryCounter]" counter
                ...
                <v-row >
                    ...
                    <v-col cols="4">
                        ...
                        maxlength="50"  :rules="[rules.addressLine2Counter]" counter
                        clearable hint="not required"></v-text-field>
                    </v-col>
                </v-row>
